...
// Define some easy to read aliases to keymaps
#define D_LFT LCTL(LGUI(KC_LEFT))
#define D_RGT LCTL(LGUI(KC_RGHT))
#define D_OVW LGUI(KC_TAB)

/*
 * Layer with all transparent keys for ease of use:
...
[WIN_BASE] = LAYOUT_ansi_84(
     ...
     KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            LGUI(LALT(KC_K)),
     KC_LCTL, KC_A, LT(NAV,KC_S), LT(DTOP,KC_D), LT(VIM, KC_F),  KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,             QK_LOCK,
     KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,            KC_UP,              MO(WIN_FN),
     KC_LCTL,  KC_LGUI,  KC_LALT,                      LT(WIN_FN,KC_SPC),                                 KC_RALT, KC_RGUI,KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[WIN_FN] = LAYOUT_ansi_84(
     ...
     CW_TOGG,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,            _______,  _______,  _______,
     _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______,  _______),

[VIM] = LAYOUT_ansi_84(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
     _______,  _______,  _______,  KC_ESC,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
