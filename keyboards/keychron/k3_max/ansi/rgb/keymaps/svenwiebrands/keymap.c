...
/*
 * Layer with all transparent keys for easy of use:

[TRANSPARENT] = LAYOUT_ansi_84(
...
[WIN_BASE] = LAYOUT_ansi_84(
     ...
     S(KC_CAPS),         KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,      RSFT(CW_TOGG),  KC_UP,    KC_END,
